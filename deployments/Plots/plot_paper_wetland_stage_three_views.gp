...
reanalysis_file = "Wetland_assimilation/outputs/paper_plot_inputs/reanalysis_normalized.csv"
...
plot [x0:x1] assim_file using (epoch($1)):4 with lines lc rgb c_assim lw lw_curve title "Assimilation", \
             reanalysis_file using (epoch($1)):4 with lines lc rgb c_reanalysis lw lw_curve title "Reanalysis", \
...
plot [x2:x3] assim_file using (epoch($1)):4 with lines lc rgb c_assim lw lw_curve notitle, \
             reanalysis_file using (epoch($1)):4 with lines lc rgb c_reanalysis lw lw_curve notitle, \
...
unset title
plot [x0:x1] assim_file using (epoch($1)):6 with lines lc rgb c_assim lw lw_curve notitle, \
             reanalysis_file using (epoch($1)):6 with lines lc rgb c_reanalysis lw lw_curve notitle, \
             truth_file every sub_every using (epoch($1)):6 with points lc rgb c_truth pt 7 ps ps_truth notitle
unset ylabel
plot [x2:x3] assim_file using (epoch($1)):6 with lines lc rgb c_assim lw lw_curve notitle, \
             reanalysis_file using (epoch($1)):6 with lines lc rgb c_reanalysis lw lw_curve notitle, \
             truth_file every sub_every using (epoch($1)):6 with points lc rgb c_truth pt 7 ps ps_truth notitle
...
plot [x0:x1] assim_file using (epoch($1)):7 with lines lc rgb c_assim lw lw_curve notitle, \
             reanalysis_file using (epoch($1)):7 with lines lc rgb c_reanalysis lw lw_curve notitle, \
             truth_file every sub_every using (epoch($1)):7 with points lc rgb c_truth pt 7 ps ps_truth notitle
unset ylabel
set xlabel "Simulated date" offset 0,-0.6
plot [x2:x3] assim_file using (epoch($1)):7 with lines lc rgb c_assim lw lw_curve notitle, \
             reanalysis_file using (epoch($1)):7 with lines lc rgb c_reanalysis lw lw_curve notitle, \
             truth_file every sub_every using (epoch($1)):7 with points lc rgb c_truth pt 7 ps ps_truth notitle
