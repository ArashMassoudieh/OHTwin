...
#     gnuplot plot_truth_vs_assim_ra.gp
# For the drift case (uses Bioretention_*_drift folders, writes
# truth_vs_assim_ra_drift.png):
#     gnuplot -e "drift=1" plot_truth_vs_assim_ra.gp
...
set output "truth_vs_assim_ra" . suffix . ".png"
...
unset multiplot
print "Wrote truth_vs_assim_ra" . suffix . ".png"
